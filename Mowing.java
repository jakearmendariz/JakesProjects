...
public class Mowing {
	...
	public boolean isClear(int x1, int y1) {
		...
		if( x1 < l-1 && y1 < w-1 && x1 > 0 && y1 > 0) {
			if(lawn[x1][y1] != 'T' && lawn[x1-1][y1-1] != 'T' && lawn[x1-1][y1] != 'T' && lawn[x1+1][y1-1] != 'T'  && lawn[x1-1][y1+1] != 'T' && lawn[x1+1][y1+1] != 'T' &&
					lawn[x1+1][y1] != 'T' && lawn[x1][y1+1] != 'T'  && lawn[x1-1][y1] != 'T'  && lawn[x1][y1-1] != 'T') {
				return true;
			}
			else {
				return false;
